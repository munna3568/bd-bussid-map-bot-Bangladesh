...
MY_ID = 7304092520
DB_FILE = "bot_data.db"
ADMIN_USERNAME = "@Nayem802325"

FREE_MAPS = {"map1": ["1. ঢাকা টু রংপুর", "https://drive.google.com/drive/folders/1MqUuSO5n_o5_0WzUeyE3RQen6FXutiRW"],"map2": ["2. Bangladesh 300 Fit", "https://drive.google.com/drive/folders/1-jNRfPjI4OlGfDQEglfMuCk2mtj7hedV"],"map3": ["3. যমুনা সেতু ম্যাপ", "https://drive.google.com/file/d/123BVMajNDXwXaz7x3Y5woUKY1y4d6GAj/view?usp=drivesdk"],"map4": ["4. রাজশাহী টু বরিশাল", "https://drive.google.com/drive/folders/1FheeZ49p62z4YWxWKSU22R_2RjC4iALg"],}
PAID_MAPS = {"p5": ["5. ঢাকা টু চট্টগ্রাম", "https://drive.google.com/drive/folders/169GKO51_Dyg6XEAkLO0hrT2WymW87cbM"],"p6": ["6. ঢাকা টু খুলনা টু বরিশাল ভায়া", "https://drive.google.com/drive/folders/12-IlJJzulZF-B-JAnjK9ZEvLgcrxUxxL"],"p7": ["7. সুন্দরবন ম্যাপ", "https://drive.google.com/drive/folders/1yq9N7zucXZL4PuGBJLzsSzi3xgE2e7sv"],"p8": ["8. চট্টগ্রাম টু কক্সবাজার", "https://drive.google.com/drive/folders/1qB8bMLI7o7r3EibXx0796V5NTU4nM9ZS"],"p9": ["9. বগুড়া টু রংপুর", "https://drive.google.com/drive/folders/1GaLRR3ObFJmW8dNERf-qfuRw5z9e2YX_"],"p10": ["10. জামালপুর টু ময়মনসিংহ", "https://drive.google.com/drive/folders/1XEsR343OtyBn4nVvbaYPOo6XVKl1UVX6"],"p11": ["11. টাঙ্গাইল টু সিরাজগঞ্জ", "https://drive.google.com/drive/folders/1_XNiE-8r3XMyuJN3T9iD0v41tmBX1HLI"],"p12": ["12. অষ্টগ্ৰাম হাওর ম্যাপ", "https://drive.google.com/drive/folders/1mNHEmcKJnO6hr7Wjcd7xcQ3Zmte8UlnF"],"p13": ["13. বাংলাদেশ ভাটিয়া রেলস্টেশন ম্যাপ+ ট্রেন মোড", "https://drive.google.com/drive/folders/13J85P8ZRDPuS-KyJrnszQfUnr-IVQVE1"],"p14": ["14. মধুমতি সেতু ম্যাপ", "https://drive.google.com/drive/folders/1edUHkKWxifFQsG_oluGXTjJGw2hNj1TN"],"p15": ["15. কুয়াকাটা টু কলাপাড়া", "https://drive.google.com/drive/folders/1ae5Qu3i2WXjMEzt9_DSK-p4eB7a3i8un"],"p16": ["16. গড়াই সেতু ম্যাপ মোড", "https://drive.google.com/drive/folders/1P77jKBlxGlAoPxKD2-VVnJNwpV1vfc7o"],"p17": ["17. বরিশাল টু খুলনা ম্যাপ", "https://drive.google.com/drive/folders/12-IlJJzulZF-B-JAnjK9ZEvLgcrxUxxL"],"p18": ["18. বান্দরবান টু খাগড়াছড়ি", "https://drive.google.com/drive/folders/1uEkN7wwXE5C_NPfYTD73xYRGJ_aiBfMb"],"p19": ["19. ঢাকা টু সিলেট ম্যাপ", "https://drive.google.com/drive/folders/1GUeCsyvH16JW5UcZ164KU0G_exjb4RiE"],"p20": ["20. বাংলাদেশী গ্ৰাম ম্যাপ", "https://drive.google.com/drive/folders/1aXHSa9p-EIfseY1UOeNRCL5riKx3KkhP"],"p21": ["21. ঢাকা মাওয়া হাইওয়ে", "https://drive.google.com/drive/folders/1mnRyQCrAFL2pHQI6dShc1lALkta5bOi5"],"p22": ["22. যমুনা রেলওয়ের সেতু ম্যাপ ও ট্রেন", "https://drive.google.com/drive/folders/1yaJZx6jZTFXReuAQHVcTObkQaL6UDVRz"],}
BUS_MODS = {"bm1": ["1. হানিফ", "coming_soon"], "bm2": ["2. শ্যামলী", "coming_soon"], "bm3": ["3. নাবিল", "coming_soon"],"bm4": ["4. এস আর লাইন", "coming_soon"], "bm5": ["5. এনা", "coming_soon"], "bm6": ["6. সি লাইন", "coming_soon"],"bm7": ["7. বিআরটিসি", "coming_soon"], "bm8": ["8. ন্যাশনাল ট্রেভেল", "coming_soon"], "bm9": ["9. সকাল সন্ধ্যা", "coming_soon"],"bm10": ["10. এনা ২.০", "coming_soon"], "bm11": ["11. সৌদিয়া মার্সিডিজ এসি", "coming_soon"], "bm12": ["12. গ্ৰামীন ট্রেভেলস", "coming_soon"],"bm13": ["13. হানিফ মার্সিডিজ বেঞ্জ", "coming_soon"],}
BUS_SKINS = {"bs1": ["1. গেমের প্রথম বাস স্কিন", "coming_soon"],"bs2": ["2. গেমের দ্বিতীয় বাস স্কিন", "coming_soon"],}
OBBS = {"obb1": ["1. স্পিড ট্রাফিক", "https://tsegaming.com/bd-map-v4-4-1-speed-traffic-obb-setup"],"obb2": ["2. মিডিয়াম স্পিড ট্রাফিক", "https://tsegaming.com/bd-ets2-v2-traffic-obb-v4-2"],"obb3": ["3. হাই ট্রাফিক স্পিড", "https://youtu.be/FKfpC8hXA9k"],"obb4": ["4. ৩.৭.১ বাংলাদেশের ওবিবি", "https://youtu.be/t_tawZcSE98?si=EDQ6xBePvUF3tkds"],"obb5": ["5. 4K Graphics OBB", "https://tsebussid.blogspot.com/2026/07/4k-graphics-obb-2026.html"],"obb6": ["6. মাল্টিপ্লয়ার OBB", "https://argamezoneofficial.blogspot.com/2026/07/download-high-speed-traffic-obb-v2-for.html"],"obb7": ["7. ৬ জিবি রেম OBB", "https://www.gamingwithsajedul.website/2026/07/apk-obb-bd-map-guide.html"],}
...
def save_user(user_id):
    conn = sqlite3.connect(DB_FILE); c = conn.cursor(); today = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    try: c.execute("INSERT INTO users (user_id, first_join) VALUES (?,?)", (user_id, today)); conn.commit()
    except sqlite3.IntegrityError: pass
    conn.close()

def encode_data(user_id, map_key):
    data = f"{user_id}:{map_key}"; encoded = base64.urlsafe_b64encode(data.encode()).decode()
    return encoded.rstrip("=")

def decode_data(encoded):
    padding = '=' * (-len(encoded) % 4); data = base64.urlsafe_b64decode(encoded + padding).decode()
    user_id, map_key = data.split(':'); return int(user_id), map_key
...
async def check_both_channels(user_id, context):
    try: # FIXED: Error holeo crash korbe na
        ...
        logging.error(f"Channel check failed: {e}")
        return False # Error hole False return korbe
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.message.from_user.id; save_user(user_id)
...
async def channel_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = f"📢 **আমাদের চ্যানেল**\n\n1. ETS2: {FREE_CHANNEL_URL}\n2. BUSSID: {CHANNEL_URL}"
    await update.message.reply_text(text, disable_web_page_preview=True)

async def button_handler_fake(update: Update, context: ContextTypes.DEFAULT_TYPE, base_key):
    class FakeQuery:
    ...
    await button_handler(FakeUpdate(fake_query), context)

async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try: # FIXED: Sob error catch korbe
        ...
        if base_key == 'busmod':
            ...
            if await check_both_channels(user_id, context):
                ...
                if link == "coming_soon":
                    text = f"🚧 **{name}**\n\nখুব শীঘ্রই লিংক এড করা হবে।" + footer
                    await query.message.reply_text(text, reply_markup=InlineKeyboardMarkup(get_social_buttons() + back_btn), parse_mode='Markdown')
                else:
                    download_btn = [[InlineKeyboardButton(f"📥 {name} ডাউনলোড", url=link)]] + get_social_buttons() + back_btn
                    await query.message.reply_text(f"✅ **{name}**" + footer, reply_markup=InlineKeyboardMarkup(download_btn), parse_mode='Markdown')
            else:
            ...
            await query.message.reply_text(f"💰 **{name}**\n\nসেন্ড মানি: **40 টাকা**\nবিকাশ/রকেট: `{BKASH}`\n\nটাকা পাঠিয়ে স্ক্রিনশট এই চ্যাটে পাঠাও।" + footer, reply_markup=InlineKeyboardMarkup(back_btn), parse_mode='Markdown')
    except Exception as e:
        logging.error(f"Button Handler Error: {e}")
        await query.message.reply_text("⚠️ একটা সমস্যা হয়েছে। আবার `/start` দিন।")
...
async def screenshot_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in user_data:
        ...
        try:
            photo = update.message.photo[-1].file_id; username = update.message.from_user.username or update.message.from_user.first_name
            ...
            await update.message.reply_text(f"✅ স্ক্রিনশট পেয়েছি। `{map_name}` চেক করে ৫ মিনিটের মধ্যে লিংক দিয়ে দিবো।", parse_mode='Markdown')
            del user_data[user_id]
        except: await update.message.reply_text("⚠️ স্ক্রিনশট পাঠাতে সমস্যা হয়েছে।")
...
async def unknown_text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = "❌ ভাই বুঝলাম না।\n\nবাম পাশের নিচে দেখুন `≡ তিনটি লাইন` আছে ওটায় চাপুন \nঅথবা `/start` লিখে পাঠান।\nবট চালু হবে।"
...
async def approve_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=user_id, text=f"✅ পেমেন্ট Approved!\n\n**{name}**" + footer, reply_markup=InlineKeyboardMarkup(download_btn), parse_mode='Markdown')
