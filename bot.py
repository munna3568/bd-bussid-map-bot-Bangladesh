...
PAID_MAPS = {
    ...
    "p20": ["20. বরিশাল টু খুলনা ম্যাপ", "https://drive.google.com/drive/folders/12-IlJJzulZF-B-JAnjK9ZEvLgcrxUxxL"], # লিংক আপডেট
    "p21": ["21. ঢাকা মাওয়া হাইওয়ে", "https://drive.google.com/drive/folders/1mnRyQCrAFL2pHQI6dShc1lALkta5bOi5"],
    "p22": ["22. যমুনা রেলওয়ের সেতু ম্যাপ ও ট্রেন", "https://drive.google.com/drive/folders/1yaJZx6jZTFXReuAQHVcTObkQaL6UDVRz"], # নতুন ম্যাপ
}

user_data = {} # {user_id: map_key}
...
async def send_main_menu(target):
    keyboard = [
        ...
        [InlineKeyboardButton("💎 পেইড ম্যাপ 19টি - 40 টাকা", callback_data=get_callback_data('paid'))] # 18 থেকে 19
    ]
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if base_key == 'free':
        ...
        if "DRIVE_LINK" in link:
            await query.message.reply_text("⚠️ এই ম্যাপের লিংক এখনো এড করা হয়নি।", reply_markup=InlineKeyboardMarkup(back_btn))
            return
        text = f"💰 **{name}**\n\nপেমেন্ট: **40 টাকা**\nবিকাশ/রকেট: `{BKASH}`\n\nটাকা পাঠিয়ে স্কিনশট এই চ্যাটে পাঠাও।" + footer # নগদ বাদ
...
def main():
    ...
    print("BD Bussid Map Bot Running v5.1...")
