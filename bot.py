...
async def main():
    ...
    commands = [
        ...
        BotCommand("free", "Free Stuff"),
        BotCommand("shop", "Shop"),
        BotCommand("payment", "Payment"),
    ...
    application.add_handler(MessageHandler(filters.PHOTO | filters.Document.ALL, photo_handler))
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, text_handler))
    
    print("BD Bussid Map Bot Running v7.9...")
