...
async def map_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if base_key in FREE_MAPS:
        ...
        return ConversationHandler.END # ফ্রি ম্যাপের পর state clear
...
def main():
    ...
    # মেইন ফিক্স: per_message=True + per_chat=False
    conv = ConversationHandler(
        per_message=True, # প্রতিটা মেসেজ আলাদা Conversation
        per_chat=False, # Chat lock করবে না
    ...
    print("BD Bussid Map Bot Running v4.4...")
