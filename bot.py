import os import logging import uuid import base64 import sqlite3
...
# ===== V7.8 NEW SECTION =====
BUS_MODS = {
    "bm1": ["1. হানিফ", "https://drive.google.com/"], # এখানে তোমার লিংক বসাও
    "bm2": ["2. শ্যামলী", "https://drive.google.com/"],
    "bm3": ["3. নাবিল", "https://drive.google.com/"],
    "bm4": ["4. এস আর লাইন", "https://drive.google.com/"],
    "bm5": ["5. এনা", "https://drive.google.com/"],
    "bm6": ["6. সি লাইন", "https://drive.google.com/"],
    "bm7": ["7. বিআরটিসি", "https://drive.google.com/"],
    "bm8": ["8. ন্যাশনাল ট্রেভেল", "https://drive.google.com/"],
    "bm9": ["9. সকাল সন্ধ্যা", "https://drive.google.com/"],
    "bm10": ["10. এনা ২.০", "https://drive.google.com/"],
    "bm11": ["11. সৌদিয়া মার্সিডিজ এসি", "https://drive.google.com/"],
    "bm12": ["12. গ্ৰামীন ট্রেভেলস", "https://drive.google.com/"],
    "bm13": ["13. হানিফ মার্সিডিজ বেঞ্জ", "https://drive.google.com/"],
}

BUS_SKINS = {
    "bs1": ["1. গেমের প্রথম বাস স্কিন", "https://drive.google.com/"], # 13টা বাসের স্কিন ভিতরে
    "bs2": ["2. গেমের দ্বিতীয় বাস স্কিন", "https://drive.google.com/"], # 13টা বাসের স্কিন ভিতরে
}
...
async def approve_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        user_info = await context.bot.get_chat(user_id); username = f"@{user_info.username}" if user_info.username else user_info.first_name
    ...
    except Forbidden: await context.bot.send_message(chat_id=MY_ID, text=f"❌ ব্যর্থ!\n\nইউজার বটকে Block করেছে বা /start দেয়নি।\nUser ID: `{user_id}`", parse_mode='Markdown'); await query.edit_message_reply_markup(reply_markup=None)
    except Exception as e: logging.error(f"Approve Error: {e}"); await context.bot.send_message(chat_id=MY_ID, text=f"❌ Error: {e}")
...
async def reject_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    except Exception as e: logging.error(f"Reject Error: {e}"); await context.bot.send_message(chat_id=MY_ID, text=f"❌ Error: {e}")
