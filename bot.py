...
def get_social_buttons(): return [[InlineKeyboardButton("📺 YouTube Subscribe", url=YOUTUBE_URL)], [InlineKeyboardButton("📘 Facebook Page Follow", url=FB_URL)]] # ঠিক করে দিলাম
...
async def screenshot_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in user_data:
        ...
        except Exception as e: logging.error(f"Forward Error: {e}"); await update.message.reply_text("⚠️ স্ক্রিনশট পাঠাতে সমস্যা হয়েছে। আবার পাঠাও।")
...
def main():
    ...
    print("BD Bussid Map Bot Running v6.2...")
