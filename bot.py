...
async def post_init(application: Application):
    ...
    try:
        ...
        print(f"❌ Failed to set commands: {e}") # Error হলেও বট চলবে

def main():
    init_db()
    if not TOKEN:
        print("FATAL ERROR: TOKEN not found in Environment Variables. Please set TOKEN in Railway.")
        return
